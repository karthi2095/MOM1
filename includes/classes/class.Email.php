 ...
 */
    ...
    function add_text($text = '') {
      $this->text = convert_linefeeds(array("\r\n", "\n", "\r"), $this->lf, $text);
    }
 ...
 */
    ...
    function add_html($html, $text = NULL, $images_dir = NULL) {
      $this->html = convert_linefeeds(array("\r\n", "\n", "\r"), '<br>', $html);
      $this->html_text = convert_linefeeds(array("\r\n", "\n", "\r"), $this->lf, $text);
...
//    function build_message($params = array()) {
    function build_message($params = '') {
      ...
      $null = NULL;
      $attachments = ((not_null($this->attachments)) ? true : false);
      $html_images = ((not_null($this->html_images)) ? true : false);
      $html = ((not_null($this->html)) ? true : false);
      $text = ((not_null($this->text)) ? true : false);
 ...
 */
	...
	//echo $to_name. $to_addr. $from_name. $from_addr.$subject . $headers ;
	...
	//echo  $to, '-->subject'.$subject, $this->output, 'From: '.$from.$this->lf.implode($this->lf, $this->headers).$this->lf.implode($this->lf, $xtra_headers);
...
// Make up the date header as according to RFC822
	...
	function send_mail($to_addr,$subject = '',$body = '')
	{
		global $objSmarty;
		//echo $UserNameEmail;
		//echo "To add ".$to_addr."<br>";
		//echo "To sub ".$subject."<br>";
		//echo "To body ".$body."<br>";
		$headers.= "From: JobBookie.com<info@jobbookie.com>\r\n";
		$headers.= "Reply-To: JobBookie.com<info@jobbookie.com>\r\n";
		$headers.= "MIME-Version: 1.0\r\n";
		$headers.= "Content-type: text/html; charset=iso-8859-1\r\n";
		 
		if(@mail($to_addr,$subject,$body,$headers)){ //echo "IF";
			$objSmarty->assign("SuccessMessage","Mail has been sent successfully");
		}else{ //echo "Else";
			$objSmarty->assign("ErrorMessage","Mail has been not sent");
		}
		//return @mail($to_addr,$subject,$body,$headers);
	}
	
	function sendmail_contactEmployee($ToAddress,$Subject,$body)
	{
		global $objSmarty;
		global $config;
		
		$imgurl=$config['SiteGlobalPath']."/images/logo.png"; 
		$Subject = 'Employer '.$_SESSION['employer_companyname'].' had viewed your profile';
		$ToAddress = stripslashes($_REQUEST['to']);
		$Tomessage = nl2br(stripslashes($_REQUEST['message']));
		$ToName    = stripslashes($_REQUEST['contactname']);
				...
				<table width="600" border="1" cellpadding="7" cellspacing="0">				   
				  <tr>
					<td><table width="100%"  cellspacing="0" cellpadding="0">
					   ...
					   <tr>
						<td colspan="2">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td align="left" colspan="2" class="normal_txt7" style="padding-left: 30px;"><div class="left-header">
	          		 					<div class="logo"><img src="'.$imgurl.'" width="188" height="39" /></div>           			         
	         						</div>
	         						</td>
	         		 			</tr></table>
         		 		</td>
					  ...
					  <tr>
						<td>&nbsp;</td>
						<td align="left" valign="middle" style="padding-left: 30px;"><div align="justify" style="font-family: Arial, Helvetica, sans-serif;font-size: 12px;font-weight: normal;color: #000000;text-decoration: none;" >Hi <b>'.$ToName.'</b>,</div></td>
					  </tr>
					  <tr>						<td height="8"></td>
						<td height="8" ></td>
					  </tr>
					  <tr>
						<td>&nbsp;</td>
						<td align="left" valign="middle" style="padding-left: 30px;"><div align="justify" style="font-family: Arial, Helvetica, sans-serif;font-size: 12px;font-weight: normal;color: #000000;text-decoration: none;" >You have received message from employer <b>'.$_SESSION['employer_companyname'].'</b></div></td>
					  </tr>
					  <tr>
						<td height="16"></td>
						<td height="16" ></td>
					   ...
					   <tr>
						<td>&nbsp;</td>
						<td align="left" valign="middle" style="padding-left: 30px;"><div align="justify" style="font-family: Arial, Helvetica, sans-serif;font-size: 12px;font-weight: normal;color: #000000;text-decoration: none; padding-left: 30px;" ><p>'.$Tomessage.'</p></div></td>
					  </tr>
					   <tr>
						<td height="20"></td>
						<td height="20" ></td>
					  ...
					  <tr>
						<td height="8"></td>
						<td height="8" align="left" style="padding-left: 30px;"><div align="justify" style="font-family: Arial, Helvetica, sans-serif;font-size: 12px;font-weight: normal;color: #000000;text-decoration: none;" >Thanks,</div></td>
					  </tr>
					  <tr>
						<td height="8"></td>
						<td height="8" align="left" style="padding-left: 30px;"><div align="justify" style="font-family: Arial, Helvetica, sans-serif;font-size: 12px;font-weight: normal;color: #000000;text-decoration: none;" >JobBookie.com Team</div></td>
					  					  </tr>
					</table></td>
				  </tr>
