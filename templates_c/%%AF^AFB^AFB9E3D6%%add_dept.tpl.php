<?php /* Smarty version 2.6.3, created on 2017-04-24 04:41:40
         compiled from add_dept.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'add_dept.tpl', 55, false),array('modifier', 'htmlspecialchars', 'add_dept.tpl', 55, false),)), $this); ?>
<?php echo '
<script>
function GoBack()
{  
...
<div id="middle"> 
<form name="add_dept" id="add_dept" action="" method="post" onsubmit="return cat_valid();">
    ...
    <div class="top-bar-header">
      ...
      <div class="breadcrumbs"><a href="controlPanel.php">Homepage</a> >><a href="manage_dept.php">Department Management</a> >> Add Department</div>
    </div>
