<?php /* Smarty version 2.6.3, created on 2017-04-24 04:43:09
         compiled from edit_user.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'edit_user.tpl', 124, false),array('modifier', 'htmlspecialchars', 'edit_user.tpl', 124, false),)), $this); ?>
<?php echo '
<script>
function GoBack()
{  
...
{ 
	...
	if(Email==\'\'){
		document.getElementById(\'errmsg\').innerHTML=\'Please enter the email address\';
	...
	if(DepartmentName==\'0\'){
		document.getElementById(\'errmsg\').innerHTML=\'Please select the department name\';
...
">
    ...
    <div class="top-bar-header">
      ...
      <div class="breadcrumbs"><a href="controlPanel.php">Homepage</a> >><a href="manage_user.php">User Management</a> >>Edit User</div>
    </div>
    <div class="select-bar">
    	<div align="right">
    	<img src="img/back.gif" title="Back" alt="Back" width="32" height="32" class="navigation_link" style="cursor:pointer;margin-right: 230px;" onclick="GoBack();"/></div>
		 </div>
	...
	<div align="center" class="Success" id="sucmsg" style="color:green;"><?php echo $this->_tpl_vars['SuccessMessage']; ?>
		...
		<table border="0" cellpadding="2" cellspacing="0" class="grid-table" style="width: 70%; margin-left: 190px;">
			<tr>
				...
				<td><input type="text" name="EmployeeId" id="EmployeeId" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['Users']['0']['EmployeeId'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)))) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
" size="30" /></td>
			</tr>
			<tr>
				<td width="30%" style="padding: 15px;">Employee Name:<span class="mandatory" style="color:red">*</span></td>
				<td><input type="text" name="EmployeeName" id="EmployeeName" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['Users']['0']['EmployeeName'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)))) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
" size="30" /></td>
			</tr>
			<tr>
				<td width="30%" style="padding: 15px;">Password:<span class="mandatory" style="color:red">*</span></td>
				<td><input type="password" name="Password" id="Password" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['Users']['0']['Password'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)))) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
" size="30" /></td>
			</tr>
			
			<tr>
				<td width="30%" style="padding: 15px;">Email:<span class="mandatory" style="color:red">*</span></td>
				<td><input type="text" name="Email" id="Email" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['Users']['0']['Email'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)))) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
" size="30" /></td>
			 </tr>
			 <tr>
...
" <?php if ($this->_tpl_vars['dept'][$this->_sections['D']['index']]['Id'] == $this->_tpl_vars['Users']['0']['Department_Id']): ?> selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['dept'][$this->_sections['D']['index']]['DepartmentName']; ?>
			...
			<tr>
				...
				<td><input type="text" name="Designation" id="Designation" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['Users']['0']['Designation'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)))) ? $this->_run_mod_handler('htmlspecialchars', true, $_tmp) : htmlspecialchars($_tmp)); ?>
" size="30" /></td>
			</tr>
			<tr class="bg">
