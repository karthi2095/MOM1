<?php /* Smarty version 2.6.3, created on 2017-04-24 05:31:31
...
<div id="login-panel">
		<div id="center-column"> 
			...
			<input type="hidden" name="hdAction" id="hdAction"></input>
				<div id="error" style="color:red; align: center; font-weight: bold;"><span id="valid"><?php if ($_REQUEST['err'] != ''):  echo $_REQUEST['err'];  endif; ?></span></div>
