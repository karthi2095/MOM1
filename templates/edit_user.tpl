	...
	<div align="center" class="Success" id="sucmsg" style="color:green;">{$SuccessMessage}</div>
		<table border="0" cellpadding="2" cellspacing="0" class="grid-table" style="width: 70%; margin-left: 190px;">
			<tr>
				...
				<td><input type="text" name="EmployeeId" id="EmployeeId" value="{$Users.0.EmployeeId|stripslashes|htmlspecialchars}" size="30" /></td>
			</tr>
			<tr>
				<td width="30%" style="padding: 15px;">Employee Name:<span class="mandatory" style="color:red">*</span></td>
				<td><input type="text" name="EmployeeName" id="EmployeeName" value="{$Users.0.EmployeeName|stripslashes|htmlspecialchars}" size="30" /></td>
			</tr>
			<tr>
				<td width="30%" style="padding: 15px;">Password:<span class="mandatory" style="color:red">*</span></td>
				<td><input type="password" name="Password" id="Password" value="{$Users.0.Password|stripslashes|htmlspecialchars}" size="30" /></td>
			</tr>
			
			<tr>
				<td width="30%" style="padding: 15px;">Email:<span class="mandatory" style="color:red">*</span></td>
				<td><input type="text" name="Email" id="Email" value="{$Users.0.Email|stripslashes|htmlspecialchars}" size="30" /></td>
			 </tr>
			 <tr>
			...
			<tr>
				...
				<td><input type="text" name="Designation" id="Designation" value="{$Users.0.Designation|stripslashes|htmlspecialchars}" size="30" /></td>
			</tr>
			<tr class="bg">
