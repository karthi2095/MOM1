...
<div id="wrapper">
	...
	<ul id="top-navigation">
		<li><a href="controlpanel.php" class="navigation_link">Homepage</a></li>
		<li><a href="manage_dept.php" class="navigation_link">Department</a></li>
		<li><a href="manage_user.php" class="navigation_link">Users</a></li>
		<li class="active"><a href="manage_meeting.php" class="navigation_link">Meetings</a></li>
	</ul>
	</div>
   ...
   <div class="manage-grid">
	<table border="0" cellpadding="2" cellspacing="0" class="grid-table" style="width: 100%; border: none; background-color: #f5f6f7;">
		...
		<table border="0" cellpadding="2" cellspacing="0" class="grid-table" style="width: 100%";>
			...
			<?php if(($_GET['action']=='l')&&($_GET['status']=='o')){ ?>
			<tr>
				<td style="text-align:center;">1</td>
				<td>Requirement Discussion</td>
				<td>Dec 20, 2016</td>
			...
			<?php  if(($_GET['action']=='l')&&($_GET['status']=='c')){ ?>
			<tr>
				<td style="text-align:center;">1</td>
				<td>Project Scope</td>
				<td>Dec 20, 2016</td>
