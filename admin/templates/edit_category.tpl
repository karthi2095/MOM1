...
<div id="middle">
		...
		<div id="center-column">
			<div class="top-bar">
				...
				<table class="listing form" cellpadding="0" cellspacing="0">
					<tr>
						<th class="full" colspan="2">Edit Pet Category</th>
					</tr>
					<tr class="bg">
						<td class="first">&nbsp;</td>
						<td class="last">&nbsp;</td>
						...
						<tr>
							<td style="text-align:right;" width="35%"><strong>Category: </strong><font color="#FF0000">*</font></td>
							<td class="first style3" width="65%"><input type="text" id="category" 
							class="editable" name="category" value="{$User.0.Category|stripslashes|htmlspecialchars}"  maxlength="30" /></td>
						</tr>
		...
		<div id="right-column">
			...
			<div class="box">Here you can edit the pet Category.</div>
	  </div> 
	</div>