...
<div id="middle">
		...
		<div id="center-column">
			<div class="top-bar">
				...
				<h1>Teams</h1>
				<div class="breadcrumbs"><a href="controlpanel.php">Homepage</a> / Teams</div>
			</div><br />
			...
			<input type="hidden" name="page" value="{$smarty.request.page}">
			  <div class="select-bar">
				...
				<label>
				<input type="text" name="keyword" value="{$smarty.request.keyword|stripslashes|htmlspecialchars}" /></label>
	 ...
	 <div align="center" class="Error">{$ErrorMessage}</div>
	  ...
	  {/if}
				<div class="table">
					...
					<table class="listing" cellpadding="0" cellspacing="0">
						<tr>
							...
							<th><span style="cursor: pointer;  text-decoration:underline;" onclick="sortsub1()">Team</span></th>
							<th >Action</th>
						...
						<tr class="{$classname}">
							...
							<td class="first style1">{$CatsList[C].Team|stripslashes|htmlspecialchars|ucfirst} </td>
						...
						{sectionelse}
						<tr class="{$classname}">
							<td align="center" colspan="4" class="style1">No Teams Found</td>
						</tr>
						{/section}
						{else}
						<tr class="{$classname}">
		...
		<div id="right-column">
			...
			<div class="box">Teams Management</div>
	  </div>
	</div>